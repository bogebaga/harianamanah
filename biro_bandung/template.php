...
<head>
	...
	if($d['gambar']!=''){
	echo "../foto_berita/small_$d[gambar]";
	}else{
	echo "../images/amanah.jpg";
	}
	?>" />
    ...
    <link href="../css/daerah/structure.css" rel="stylesheet">
	...
	<!-- Custom CSS -->
    <link rel="stylesheet" href="../css/daerah/style.css">
    <link rel="stylesheet" href="../css/daerah/new.css">
    <link rel="stylesheet" href="../css/daerah/paging.css">
	...
	<div class="tengah">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="../">
				<div class="logo"><img src="../images/amanah.png" height="35px" width="165px"></div>
			</a>
		</div>
