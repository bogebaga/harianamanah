			...
			<div class="col-md-12">
				<div class="col-md-3">
					<div class="row">
                		...
                		<h4>Islamic View</h4></br>
                			<ul class="featured_nav">
                  			
                  			
							<?php 
							$terkini=mysql_query("SELECT * FROM berita WHERE  id_kategori = '67' ORDER BY id_berita DESC limit 4 ");
							while($t=mysql_fetch_array($terkini)){
								
							echo "
							<li>
							
							<a class='featured_img' href='berita-$t[judul_seo].html'><img src='../foto_berita/$t[gambar]'></a>
					...
					<div class="row">
                		<div class="single_blog_sidebar1 wow fadeInUp">
                			<h4>Opini</h4></br>
                  			...
                  			<?php 
							$terkini=mysql_query("SELECT * FROM berita WHERE  id_kategori = '68' ORDER BY id_berita DESC limit 3 ");
							while($t=mysql_fetch_array($terkini)){
					...
					<div class="row">
                		...
                		<h4>Esai</h4></br>  
                			<ul class="featured_nav2">
                  			<?php 
							$terkini=mysql_query("SELECT * FROM berita WHERE  id_kategori = '69' ORDER BY id_berita DESC limit 4 ");
							while($t=mysql_fetch_array($terkini)){
