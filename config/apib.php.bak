...
//    $dae = anti_injection($_GET['daerah']);
    ...
    $field = "judul,
                ...
                tanggal,
                '1' as urutan,
                CONCAT('".$base_gambar."foto_berita/',gambar) as gambar,
                CONCAT('".$base_gambar."foto_small/',gambar1) as gambar1,
                CONCAT(CONCAT('".$base_url."berita-',judul_seo),'.html') as judul_seo,
                jam,
                b.id_kategori,
                nama_kategori,
                isi_berita,
    ...
    if(!empty($kat)&&$row_menu['id_parent']==0){
      if ($kat == 79) {
        ...
        where (b.id_kategori = '88' OR b.id_kategori = '76') and k.aktif='Y'
    ...
    elseif(!empty($kat)&&$row_menu['id_parent']!=0){
        ...
        if($id_menu==71){
            ...
            '2' as urutan,
            tanggal,
            CONCAT('".$base_gambar."img_video/',gbr_video) as gambar,
            CONCAT('".$base_gambar."img_video/kecil_',gbr_video) as gambar1
            ,CONCAT(CONCAT('".$base_url."video-',video_seo),'.html') as judul_seo,
        ...
        elseif ($id_menu==75) {
          $field = "id_album,
                    ...
                    CONCAT('".$base_gambar."img_album/', gbr_album) as gambar,
                    CONCAT('".$base_gambar."img_album/', gbr_album) as gambar1,
                    CONCAT(CONCAT('".$base_url."foto-',album_seo),'.html') as judul_seo,
                    jam,
                    '75' as id_kategori,
...
function getDetailBeritaFoto(){
  ...
  $sql = mysql_query("SELECT keterangan,
                    CONCAT('".$base_gambar."img_galeri/', gbr_gallery) as gbr_gallery
