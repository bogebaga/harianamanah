...
function navHalaman($halaman_aktif, $jmlhalaman){
	...
	{
		$prev = $halaman_aktif-1;
		$link_halaman .= "<li><a href=?halaman=1 class='nextprev'>Awal</a></li>
		<li><a href=?halaman=$prev class='nextprev'>Kembali</a></li>";
	}
	else
	{
		$link_halaman .= "<li><span class='nextprev'>Awal</span><span class='nextprev'>Kembali</span></li>  ";
	...
	// Link ke halaman berikutnya (Lanjut) dan terakhir (Akhir)
		if($halaman_aktif < $jmlhalaman){
			...
			$link_halaman .= " <li><a href=?halaman=$next class='nextprev' >Lanjut</a></li>
												<li><a href=?halaman=$jmlhalaman class='nextprev'>Akhir</a></li>";
		}
		else
		{
			$link_halaman .= "<li><span class='nextprev'>Lanjut</span><span class='nextprev'>Akhir</span></li>";
