...
<div id="page-content" class="index-page container" style="background-color:#ececec;">
    ...
    <div id="sidebar" style="padding:0;background:#ECECEC;">
      ...
      <div class="col-xs-9 news-category" style="background:#fff;">
          ...
          <br>
          <?php
          $terkini=mysql_query("SELECT * FROM berita b JOIN (kategori k JOIN menu m ON k.id_kategori = m.id_menu ) ON b.id_kategori = k.id_kategori WHERE  m.id_parent = '18' ORDER BY id_berita DESC LIMIT 33");
