...
<h1 style="color:#673ab7;border-bottom:1px solid #673ab7"><?php echo $nama_menu['nama_menu']?></h1>
    <div id="sidebar" style="padding:0;background:#ECECEC;">
      ...
      <div class="col-xs-3" style="padding-left:0;">
        <div style="padding:10px;background-color: #673ab7;background-image: -webkit-linear-gradient(95deg, #673ab7 50%, #6a4b96 100%);background-image: -moz-linear-gradient(95deg, #673ab7 50%, #6a4b96 100%);background-image: -o-linear-gradient(95deg, #673ab7 50%, #6a4b96 100%);background-image: linear-gradient(95deg, #673ab7 50%, #6a4b96 100%);">
          <ul>
          <h1 style="color:#fff;border-bottom:1px solid #fff;margin:0 0 15px 0;"><?php echo $nama_menu['nama_menu']?></h1>
          <?php
            $submenu = mysql_query("SELECT * FROM menu WHERE id_parent='20'");
