...
<div id="sidebar">
      ...
      <div class="dua-atas">
            ...
            <div class="related-news">
              ...
              <div class="row">
                <h2 style="padding:13px 15px;text-align:left;text-transform:uppercase !important;font-weight:bold !important; color:#fff;margin-bottom:20px;<?php echo $menu['gradient']?>">FOTO LAINNYA</h2>
              </div>
