	...
	<script>
		...
		$(window).scroll(function(){
			...
			if(($(window).scrollTop()+nearbottom >= $(document).height()-$(window).height()) && loadMore)
			{
				loadMore = false;
				$.ajax({
					url: 'more-web.php?kategori=sosok&urut_1='+$('li[data-kategori=khazanah]:last').attr('kode')+'&urut_2='+$('li[data-kategori=legenda]:last').attr('kode')+'&urut_3='+$('li[data-kategori=terkini]:last').attr('kode'),
					beforeSend: function()
					{
						$('#more').show();
					},
