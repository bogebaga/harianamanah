  ...
  <section class="container-fluid" style="background-color:white;padding: 0 10px;">
      ...
      <div id='home-carousel' class='carousel slide' data-ride="carousel">
        <div class="carousel-inner"> 
          ...
          echo"
              <div class='item'>
                <img class='lazy' src='".SITE_URL."assets/base.jpg' data-src='http://harianamanah.com/foto_berita/$t[gambar]' alt='$t[judul]' style='width:100%;height:285px;object-fit:cover;'>
                <span class='judul-berita-utama'>
                  <div class='caption-dt-jd'>
                    <h3><a href='".SITE_URL."berita-$t[judul_seo]' title='$t[judul]'>$t[judul]</a></h3>
    ...
    <?php
    $x=1;
    $artikel=mysql_query("SELECT * FROM menu JOIN (kategori JOIN berita ON kategori.id_kategori = berita.id_kategori) ON menu.nama_menu = kategori.nama_kategori AND menu.id_parent = (SELECT id_menu FROM menu WHERE link = '$_GET[jn]') AND berita.id_berita < $id ORDER BY berita.id_berita DESC LIMIT 35");
    while($q=mysql_fetch_array($artikel))
    {
        ...
        while($foto=mysql_fetch_array($inilah)):
          ...
          <div class='list-picture'>
            <a href='".SITE_URL."berita-$q[judul_seo]'>
              <img class='picture lazy' src='".SITE_URL."assets/base.jpg' data-src='http://harianamanah.com/foto_berita/$q[gambar1]' alt='$q[judul]' style='width:100%;height:auto;object-fit:cover;'>
            </a>
          </div>
      ...
      echo "<article class= 'artikle' >
        <div class='list-picture'>
          <a href='".SITE_URL."berita-$q[judul_seo]'>
            <img class='picture lazy' src='".SITE_URL."assets/base_n.jpg' data-src='http://harianamanah.com/foto_small/$q[gambar1]' alt='$q[judul]'/>
          </a>
        </div>
    ...
    <br>
      ...
      <a href="http://abutours.com" title="AbuTours.com">
          <img class="img-responsive" src="<?= SITE_URL;?>assets/abujie.jpg" alt="iklan">
      </a>
    </div>
      ...
      while($main = mysql_fetch_array($rubrik))
      {
        ...
        while($fill = mysql_fetch_array($artikel))
        {
          ...
          <div class=\"content-image\" style='position:relative;'>
            <img class='lazy' src='".SITE_URL."assets/base.jpg' data-src=\"http://harianamanah.com/foto_berita/$fill[gambar]\" width='100%' alt=\"$fill[judul]\" style='object-fit:cover;height:215px;'>
            <div>
            <span class='judul-berita-utama'>
              <div class='caption-dt-jd'>
                <h3><a href='".SITE_URL."berita-$fill[judul_seo]' title='$fill[judul]'>$fill[judul]</a></h3>
