<?php function ulangi(){ 
	...
	$terkini1 = mysql_query("SELECT * FROM menu JOIN (kategori JOIN berita ON kategori.id_kategori = berita.id_kategori) ON menu.nama_menu = kategori.nama_kategori AND menu.id_parent = '13' ORDER BY berita.id_berita DESC LIMIT $digit, 1");
	...
	<section class="container-fluid">
			...
			<section class="daftar-artikel">
				<?php 
					$artikel = mysql_query("SELECT * FROM menu JOIN (kategori JOIN berita ON kategori.id_kategori = berita.id_kategori) ON menu.nama_menu = kategori.nama_kategori AND menu.id_parent = '13' AND id_berita != '$id1' ORDER BY berita.id_berita DESC LIMIT $digit, 5");
