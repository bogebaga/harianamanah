      ...
      <div id="menuSamping" class="sidenav">
        ...
        <ul class="nav navbar-nav container-log">
          ...
          <li class='tagging-pilgub'><a href='./' >
            <img src="http://192.168.1.86/harianamanah/pilkada/appicicu.png" alt="appicicu - harianamanah.com"></a></li>
        ...
        <ul class="nav navbar-nav container-log">
          ...
          <li class='tagging-walkot'>
            <a href='./' >
              <img src="http://192.168.1.86/harianamanah/pilkada/appicicu.png" alt="appicicu - harianamanah.com">
            </a>
          </li>
          <li class='tagging-walkot'>
            <a href='popular'>
              <img src="http://192.168.1.86/harianamanah/pilkada/diami.png" alt="diami - harianamanah.com">
            </a>
          </li>
        </ul>
        <hr>
