...
$arrLang['normal_installation'] = "Normal Installation";
$arrLang['normal_description']  = "The main version. It can manage a remote Lite Installations";
$arrLang['lite_installation']   = "Lite Installation";
$arrLang['lite_description']    = "Lightweight version. No direct access, manageable from a remote Normal Installation(s)";
...
$arrLang['email']               = "Your E-Mail";
$arrLang['proceed']             = "Continue to Project SECURITY";
$arrLang['put_code']            = "Now put this code in a main file of your website to enable Project SECURITY (Change \"projectsecurity_folder\" with the path on which you installed the product)";
$arrLang['success_install']     = "Project SECURITY has been successfully installed on your website!";
?>