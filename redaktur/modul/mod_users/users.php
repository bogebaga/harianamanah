...
echo "";
   ...
   <input type=text name='no_telp'size=50>
      ...
      <p class='inline-small-label'>
   <label for=field4>Pilih Daerah</label>
   <select name='pilih_daerah' id='pilih_daerah'>
   ...
   $data_kota = ['makassar','kendari','jakarta','surabaya','semarang','bandung','balikpapan','palembang','medan'];
